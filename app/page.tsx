...
const ProjectsPage = async () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-slate-100 p-6 sm:p-10 font-sans">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex items-center gap-2 text-slate-200 border-b border-slate-800/60 pb-4">
