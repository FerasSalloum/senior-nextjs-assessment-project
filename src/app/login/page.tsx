  ...
  return (
    <>
      ...
      <div className=" min-h-screen flex flex-col items-center justify-center p-10 dark:bg-[#0B0F19] scroll-auto">
        ...
        <div className="w-full max-w-md dark:bg-[#131825]/90 border border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
          <form
            className="space-y-5"
            onSubmit={(e) => {
              e.preventDefault();
          ...
          >
            <div className="space-y-2">
              ...
              <div className="relative flex items-center dark:bg-[#1A202C] rounded-xl border border-slate-800 focus-within:border-cyan-500/50 transition-colors overflow-hidden">
                ...
                <input
                  ...
                  dir="ltr"
                  className="w-full text-black bg-transparent py-3.5 pl-4 pr-11 text-sm dark:text-slate-200 dark:placeholder-slate-500 placeholder-gray-500 outline-none text-left"
                  value={email}
                  onChange={(e) => {
            ...
            <div className="space-y-2 pb-2">
              ...
              <div className="relative flex items-center dark:bg-[#1A202C] rounded-xl border dark:border-slate-800 focus-within:border-cyan-500/50 transition-colors overflow-hidden">
                <div className="absolute right-4 dark:text-slate-500 pointer-events-none">
                ...
                <input
                  ...
                  placeholder="**********"
                  dir="ltr"
                  className="w-full bg-transparent py-3.5 pl-11 pr-11 text-sm dark:text-slate-200 dark:placeholder-slate-500 outline-none text-left tracking-widest font-sans"
                  onChange={(e) => {
